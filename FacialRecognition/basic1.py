...
mButton=Button(text="Dataset",command=detaset).place(x=210,y=280)
mButton2=Button(text="Train",command=detaset2).place(x=215,y=320)
mButton3=Button(text="Recognition",command=detaset3).place(x=200,y=360)
gui.mainloop()